...
<div class="Module">
    ...
    <div class="Row" align="center">
            <input type="button" value="<%=Resources.InstrumentResultStrings.InstrumentResult_View%>" id="btnView"/>
            <input type="button" value="<%=Resources.InstrumentResultStrings.InstrumentResult_Update%>" id="btnUpdate" />
            <input type="button" value="<%=Resources.InstrumentResultStrings.InstrumentResult_ChangeSID%>" id="btnChangeID" />
            <%= Html.ActionLink("Đổi SID", "PopUp", null, new { target = "_blank" })%>
     </div>
</div>
