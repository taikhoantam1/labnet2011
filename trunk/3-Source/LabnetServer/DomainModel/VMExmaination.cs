...
namespace DomainModel
{
    public class VMExamination
    {
        ...
        [JQColumnAttribute("VMExmaination_LabClient", true, false, false, EditTypeEnum.Text, FormatterEnum.Text)]
        public string LabClient { get; set; }
    }
}
