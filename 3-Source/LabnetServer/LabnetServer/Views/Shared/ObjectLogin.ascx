    ...
    function btnLogin_onclick() {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.Message == "SuccessDoctor") {
                    window.location = "/BacSi";
                }
                else if (data.Message == "SuccessLab") {
                    window.location = "/Lab";
                }
                else {
                    $.unblockUI();
...
<div id="loginWrapper">
    <div id="key">
        <img src="/Content/Images/ObjectLogin.png" alt="Login">
    </div>
    <div id="login">
        <div>
            <label for="type">
                Liên Kết:</label>
            <select id="cbxType">
              <option value="0" selected=selected>Bác Sĩ</option>
              <option value="1">Lab Liên Kết</option>
            </select>
        ...
        <div>
            ...
            value="Đăng Nhập"
            width="67px" />
            <input id="btnRegister" type="button" class="multi_modal_link" href="/Home/Register" value="Đăng Ký"
                style=" -webkit-appearance: none;
                        -webkit-box-align: center;
                        -webkit-box-shadow: rgba(0, 0, 0, 0.0976563) 0px 1px 1px 0px;
                        -webkit-rtl-ordering: logical;
